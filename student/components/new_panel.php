<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark min-vh-100">
    <a href="<?= $rootURL ?>/student/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="<?= $rootURL ?>/student/account_information.php" class="nav-link text-white" aria-current="page">
                Account Information
            </a>
        </li>
        <li class="nav-item">
            <a href="<?= $rootURL ?>/student/assessments.php" class="nav-link text-white" aria-current="page">
                Assessments
            </a>
        </li>
        <li class="nav-item">
            <a href="<?= $rootURL ?>/student/results.php" class="nav-link text-white" aria-current="page">
                Results
            </a>
        </li>
    </ul>
