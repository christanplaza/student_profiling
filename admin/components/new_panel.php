<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark min-vh-100">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="<?= $rootURL ?>/admin/faculty_management.php" class="nav-link text-white" aria-current="page">
                Faculty Management
            </a>
        </li>
        <li>
            <a href="<?= $rootURL ?>/admin/questionnaire_management.php" class="nav-link text-white">
                Questionnaire Management
            </a>
        </li>
        <li>
            <a href="<?= $rootURL ?>/admin/masterlist.php" class="nav-link text-white">
                Masterlist
            </a>
        </li>
    </ul>
